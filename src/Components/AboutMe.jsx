    ...
    <div className='Sections'>
      ...
      <div className="AboutMeSection">
        <div className="AboutMe">
          ...
          <p>I grew up with a passion for art and design. However, fell in love with tech along the way. I pursued IT as a career to expose myself to new business apps and how to integrate them. During my tenure in IT, I was always exposed to programming and had an interest in learning - to the point I took a loop of faith and decided to jump careers via Hack Reactor's Software Engineering Immersive coding bootcamp. It was an amazing and fun experience learning what I know so far, and I know I still have much more to learn after graduating and definitely excited to do so! I am currently looking for a role!</p>
